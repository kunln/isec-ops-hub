...
from .client import close_http_client, ensure_telegram_http_allowed, get_http_client
from .config import (
    clean_bot_username,
    coerce_int,
    coerce_str,
...
class TelegramChannel(ChannelPlugin):
    ...
    async def send_text(self, ctx: OutboundContext) -> DeliveryResult:
        ...
        await ensure_telegram_http_allowed(send_url, purpose="Telegram send message")

...
async def get_access_token(app_key: str, app_secret: str) -> str:
    ...
    async with key_lock:
        ...
        await _ensure_channel_http_allowed(DINGTALK_TOKEN_URL, purpose="DingTalk access token request")
...
async def api_request(
    ...
    *,
    ...
    await _ensure_channel_http_allowed(url, purpose="DingTalk API request")
    client = await _get_http_client()

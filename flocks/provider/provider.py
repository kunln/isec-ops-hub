...
def _provider_outbound_url(provider: Any) -> str | None:
...
class Provider:
    ...
    async def chat(
        ...
        **kwargs
        ...
        await _ensure_provider_outbound_allowed(
            provider,
            purpose=f"LLM provider request: {model.provider_id}",
        )
    ...
    async def chat_stream(
        ...
        **kwargs
        ...
        await _ensure_provider_outbound_allowed(
            provider,
            purpose=f"LLM provider stream request: {model.provider_id}",
        )
    ...
    async def embed(
        ...
        **kwargs
        ...
        await _ensure_provider_outbound_allowed(
            provider,
            purpose=f"embedding provider request: {provider_id}",
        )
    ...
    async def embed_batch(
        ...
        **kwargs
        ...
        await _ensure_provider_outbound_allowed(
            provider,
            purpose=f"embedding provider batch request: {provider_id}",
        )

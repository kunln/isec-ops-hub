...
def _service_config(
    ...
    skip_commercial_admin_build: bool = False,
    server_host: Optional[str] = None,
    server_port: Optional[int] = None,
    webui_host: Optional[str] = None,
    webui_port: Optional[int] = None,
    commercial_admin_host: Optional[str] = None,
    commercial_admin_port: Optional[int] = None,
    ...
    default_commercial_admin_host: Optional[str] = None,
    default_commercial_admin_port: Optional[int] = None,
) -> ServiceConfig:
    ...
    return ServiceConfig(
        ...
        frontend_port=_resolve_port(
            ...
            default=default_webui_port or 8080,
            label="webui",
        ),
        commercial_admin_frontend_host=_resolve_host(
            cli_value=commercial_admin_host,
            env_names=("FLOCKS_COMMERCIAL_ADMIN_HOST", "FLOCKS_COMMERCIAL_ADMIN_FRONTEND_HOST"),
            default=default_commercial_admin_host or "127.0.0.1",
        ),
        commercial_admin_frontend_port=_resolve_port(
            cli_value=commercial_admin_port,
            env_names=("FLOCKS_COMMERCIAL_ADMIN_PORT", "FLOCKS_COMMERCIAL_ADMIN_FRONTEND_PORT"),
            default=default_commercial_admin_port or 51174,
            label="commercial admin webui",
        ),
        no_browser=no_browser,
        skip_frontend_build=skip_webui_build,
        skip_commercial_admin_frontend_build=skip_commercial_admin_build,
    )
...
def _restart_runtime_defaults() -> dict[str, Any]:
    ...
    commercial_admin = (
        read_runtime_record(paths.commercial_admin_frontend_pid)
        if paths.commercial_admin_frontend_pid is not None
        else None
    )
    ...
    if commercial_admin is not None:
        if commercial_admin.host:
            defaults["default_commercial_admin_host"] = commercial_admin.host
        if commercial_admin.port is not None:
            defaults["default_commercial_admin_port"] = commercial_admin.port
    return defaults
...
def _restart_service_config(
    ...
    return _service_config(
        ...
        skip_commercial_admin_build=skip_commercial_admin_build,
        server_host=server_host,
        server_port=server_port,
        webui_host=webui_host,
        webui_port=webui_port,
        commercial_admin_host=commercial_admin_host,
        commercial_admin_port=commercial_admin_port,
...
def start(
    ...
    skip_webui_build: bool = typer.Option(
        False,
        "--skip-webui-build",
        "--skip-frontstage-build",
        help="Skip `npm run build` before starting WebUI",
    ),
    skip_commercial_admin_build: bool = typer.Option(
        False,
        "--skip-commercial-admin-build",
        help="Skip `npm run build` before starting commercial admin WebUI",
    ),
    ...
    webui_port: Optional[int] = typer.Option(None, "--webui-port", "--frontstage-port", help="Frontstage WebUI port"),
    commercial_admin_host: Optional[str] = typer.Option(None, "--commercial-admin-host", help="Commercial admin WebUI host"),
    commercial_admin_port: Optional[int] = typer.Option(None, "--commercial-admin-port", help="Commercial admin WebUI port"),
):
    """
...
def logs(
    ...
    commercial_admin: bool = typer.Option(False, "--commercial-admin", help="Only show commercial admin WebUI logs"),

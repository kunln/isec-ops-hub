...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for Flocks.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal sessions
...
flocks acp --cwd /path/to/project
```
...
- **Terminal Integration**: Full terminal support via bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | flocks acp
```
...
### Mapping to Internal Sessions

ACP sessions map cleanly to internal session model:

...
import type { ProviderAuthAuthorization } from "@flocks-ai/sdk/v2"
        ...
        props.providerID === "opencode" ? (
          <box gap={1}>
            <text fg={theme.textMuted}>
              Configure your AI provider to access various language models.
            </text>
            <text fg={theme.text}>
              Get API keys from your provider's website
            </text>
          </box>
        ) : undefined
      }

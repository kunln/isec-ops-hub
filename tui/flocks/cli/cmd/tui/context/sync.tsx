import type {
  ...
  ProviderAuthMethod,
  VcsInfo,
} from "@flocks-ai/sdk/v2"
import { createStore, produce, reconcile } from "solid-js/store"
import { useSDK } from "@tui/context/sdk"
import { Binary } from "@flocks-ai/util/binary"
...
import type { Path } from "@flocks-ai/sdk"
    ...
    sdk.event.listen((e) => {
      ...
      switch (event.type) {
        ...
        case "permission.replied": {
          if (!event.properties.sessionID || !event.properties.requestID) break
        ...
        case "message.removed": {
          if (!event.properties.sessionID || !event.properties.messageID) break
        ...
        case "message.part.updated": {
          if (!event.properties.part) break
        ...
        case "message.part.removed": {
          if (!event.properties.messageID || !event.properties.partID) break
        ...
        case "vcs.branch.updated": {
          if (!event.properties.branch) break

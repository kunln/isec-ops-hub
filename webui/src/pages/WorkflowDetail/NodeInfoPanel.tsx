...
export default function NodeInfoPanel({ node, workflow, latestExecution, width = 260, onClose, onSaved, readOnly = false }: NodeInfoPanelProps) {
  const { t } = useTranslation('workflow');
  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 px-3 py-3 border-t border-gray-100 space-y-1.5">
        {readOnly && (
          <p className="text-[11px] text-blue-600">{t('detail.nodeInfo.readonlyBuiltin')}</p>
        )}
        {saveErr && (

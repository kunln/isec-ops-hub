...
class TestToolRouteAPIServiceSync:
    ...
    async def test_update_tool_allows_api_tool_toggle(self):
        ...
        with (
            ...
            patch("flocks.config.config_writer.ConfigWriter.get_api_service_raw", return_value={"enabled": True}),
            patch("flocks.config.config_writer.ConfigWriter.set_tool_setting") as mock_set_tool_setting,
            patch("flocks.config.config_writer.ConfigWriter.delete_tool_setting") as mock_delete_tool_setting,
            ...
            mock_set_tool_setting.assert_called_once_with("threatbook_ip_query", {"enabled": False})
            mock_delete_tool_setting.assert_not_called()
...
class TestProviderBackedApiServiceStatus:
    ...
    async def test_provider_test_updates_api_service_status_cache_when_configured(self):
        ...
        with (
            ...
            patch("flocks.commercial.policy.ensure_outbound_allowed", new=AsyncMock()),
        ):
